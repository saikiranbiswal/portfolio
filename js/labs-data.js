/* =========================================================
   ...
   Auto-generated from content/labs.json. The live site fetches
   that file as the source of truth; this seed supports offline
   and file:// preview. Do not edit this file by hand.
   ========================================================= */
window.LABS_SEED = {
  "labs": [
    {
  ...
  "meta": {
    ...
    "glyph": "SK",
    "intro": "Start with the two flagship case studies — each one taken from a painful workflow all the way to a working prototype, with the PRD, journey, metrics, and architecture in between. Then step into any of the five discipline labs to see how each layer gets built.",
    "owner": "Sai Kiran Biswal",
    "title": "Two products, end to end. Five labs of how I work.",
    "eyebrow": "Product Portfolio · Two flagship case studies, then five labs",
    "statLabs": "5",
    "statYears": "7",
    "statProducts": "9",
    "statLabsLabel": "Labs",
