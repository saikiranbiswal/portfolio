/* =========================================================
   Labs — data model
   Six labs, each with dummy products. Everything here is the
   *default* seed; the app clones this into localStorage on first
   run and all inline edits write back to the saved copy.
   ========================================================= */
window.LABS_SEED = {
  meta: {
    owner: "Sai Kiran Biswal",
    role: "Enterprise · AI Product",
    eyebrow: "Product Portfolio · Built as a system of labs",
    title: "Six labs. One product mind across the whole stack.",
    intro: "Each lab is a discipline I work in end-to-end — from the founder's first bet to the data model, the architecture, the AI, and the product people actually use. Step into any lab to explore what it ships.",
    statLabs: "6",
    statLabsLabel: "Labs",
    statProducts: "18",
  ...
  labs: [
    {
      ...
      products: [
        { id: "northwind", name: "Northwind", stage: "Seed venture", tags: ["Venture", "Fintech"],
          ...
          features: [["Market wedge", "Underserved mid-market lenders ignored by core-banking incumbents."], ["First-customer motion", "Ten hand-picked design partners co-building the v1."], ["The narrative", "A single story that ran from cold intro to term sheet."]],
          role: "Founder & Product", year: "2024", stage2: "Seed · Raising",
          stack: ["Strategy", "GTM", "Fundraising"], url: "https://example.com/northwind" },
        { id: "atlas", name: "Atlas Collective", stage: "Operating co", tags: ["Studio", "B2B"],
          ...
          features: [["Sourcing engine", "A scored pipeline of operational pains worth productizing."], ["Stage gates", "Clear kill/continue criteria at each funding step."], ["Shared spine", "Common identity, billing, and data layer across spin-outs."]],
          role: "Founding Operator", year: "2023", stage2: "Operating",
          stack: ["Portfolio", "Ops", "Finance"], url: "https://example.com/atlas" },
        { id: "ironwood", name: "Ironwood", stage: "Prototype", tags: ["Concept", "Climate"],
          ...
          features: [["Ledger model", "Every emission is a posted, reconcilable entry."], ["Audit trail", "Defensible numbers for regulators and buyers alike."], ["Buyer signal", "Three enterprise interviews validating willingness to pay."]],
          role: "Founder & Product", year: "2025", stage2: "Concept",
          stack: ["Discovery", "Prototype", "Policy"], url: "https://example.com/ironwood" },
      ],
    },
    {
      id: "analytics",
      ...
      products: [
        { id: "pulse", name: "Pulse", stage: "Shipped", tags: ["Dashboard", "SaaS"],
          ...
          features: [["Metric tree", "A north star decomposed into inputs teams can own."], ["Weekly movers", "Automatic surfacing of what changed and why."], ["Guardrails", "Counter-metrics that keep optimization honest."]],
          role: "Lead PM", year: "2023", stage2: "Live · v3",
          stack: ["Metrics", "BI", "Looker"], url: "https://example.com/pulse" },
        { id: "cohort", name: "Cohort", stage: "Shipped", tags: ["Retention", "Growth"],
          ...
          features: [["Behavioral cohorts", "Group users by what they did, not just when they joined."], ["Activation signals", "The early actions that predict retention."], ["Experiment-ready", "Every insight ships with a testable hypothesis."]],
          role: "Lead PM", year: "2022", stage2: "Live",
          stack: ["SQL", "Stats", "dbt"], url: "https://example.com/cohort" },
        { id: "signal", name: "Signal", stage: "Beta", tags: ["Alerting", "Ops"],
          ...
          features: [["Seasonality-aware", "Knows the difference between a dip and a Tuesday."], ["Owner routing", "The right person, with context, not a firehose."], ["Trust tuning", "Aggressive false-positive suppression by design."]],
          role: "Lead PM", year: "2025", stage2: "Private beta",
          stack: ["ML", "Time-series", "Slack"], url: "https://example.com/signal" },
      ],
    },
    {
      id: "ai",
      ...
      products: [
        { id: "mirror", name: "Mirror", stage: "Shipped", tags: ["Copilot", "Enterprise"],
          ...
          features: [["Grounded suggestions", "Every recommendation cites the account facts behind it."], ["Eval harness", "Suggestions scored against expert-labeled outcomes."], ["Policy guardrails", "Hard limits the model cannot talk its way around."]],
          role: "Lead AI PM", year: "2024", stage2: "Live · Enterprise",
          stack: ["RAG", "LLM", "Evals"], url: "https://example.com/mirror" },
        { id: "synthesis", name: "Synthesis", stage: "Shipped", tags: ["Docs", "RAG"],
          ...
          features: [["Clause-level citations", "Answers point back to the source paragraph."], ["Confident refusal", "Says 'not in the document' instead of hallucinating."], ["Long-context retrieval", "Handles 200-page documents without losing the thread."]],
          role: "Lead AI PM", year: "2023", stage2: "Live",
          stack: ["RAG", "Embeddings", "Eval"], url: "https://example.com/synthesis" },
        { id: "oracle", name: "Oracle", stage: "Research", tags: ["Agents", "Workflow"],
          ...
          features: [["Plan-then-act", "The agent proposes a full plan before touching anything."], ["Approval gates", "Humans sign off on every consequential step."], ["Reversible", "Every action has a defined, tested rollback."]],
          role: "AI PM", year: "2025", stage2: "Research",
          stack: ["Agents", "Tools", "HITL"], url: "https://example.com/oracle" },
      ],
    },
    {
      id: "architecture",
      ...
      products: [
        { id: "blueprint", name: "Blueprint", stage: "Shipped", tags: ["Platform", "Design"],
          ...
          features: [["Context-first", "Boundaries and actors before any box-and-line detail."], ["Event flows", "How money, decisions, and data actually move."], ["Trade-off log", "Every significant call, written down with its why."]],
          role: "Product Architect", year: "2024", stage2: "In production",
          stack: ["C4", "Events", "APIs"], url: "https://example.com/blueprint" },
        { id: "keystone", name: "Keystone", stage: "Shipped", tags: ["Integration", "API"],
          ...
          features: [["Canonical model", "One clean internal language for many dialects."], ["Adapter pattern", "New cores plug in without touching product code."], ["Contract tests", "Integrations that fail loudly before customers do."]],
          role: "Product Architect", year: "2023", stage2: "In production",
          stack: ["DDD", "REST", "Kafka"], url: "https://example.com/keystone" },
        { id: "lattice", name: "Lattice", stage: "Concept", tags: ["Multi-tenant", "Scale"],
          ...
          features: [["Isolation model", "Hard tenant boundaries on shared infrastructure."], ["Config not fork", "Per-tenant behavior without per-tenant codebases."], ["Data residency", "Region pinning that satisfies regulators."]],
          role: "Product Architect", year: "2025", stage2: "Concept",
          stack: ["Multi-tenant", "IaC", "Cloud"], url: "https://example.com/lattice" },
      ],
    },
    {
      id: "data",
      ...
      products: [
        { id: "graphmind", name: "Graphmind", stage: "Shipped", tags: ["Entity model", "Semantic"],
          ...
          features: [["One ontology", "Shared definitions across every team and system."], ["Governed change", "Schema evolution with review, not surprise."], ["Five-into-one", "Consolidated conflicting legacy models into a spine."]],
          role: "Data Product Lead", year: "2024", stage2: "In production",
          stack: ["Ontology", "Graph", "MDM"], url: "https://example.com/graphmind" },
        { id: "registry", name: "Registry", stage: "Shipped", tags: ["Master data", "Governance"],
          ...
          features: [["Entity resolution", "Probabilistic matching across messy sources."], ["Survivorship", "Rules that pick the truest value field by field."], ["Stewardship", "A human workflow for the ambiguous matches."]],
          role: "Data Product Lead", year: "2022", stage2: "In production",
          stack: ["MDM", "Matching", "Quality"], url: "https://example.com/registry" },
        { id: "conduit", name: "Conduit", stage: "Beta", tags: ["Pipeline", "Streaming"],
          ...
          features: [["Change data capture", "Source events streamed, not polled."], ["Continuous reconcile", "The graph stays consistent in near-real-time."], ["Freshness SLAs", "Defined, monitored latency budgets."]],
          role: "Data Product Lead", year: "2025", stage2: "Private beta",
          stack: ["CDC", "Kafka", "Flink"], url: "https://example.com/conduit" },
      ],
    },
    {
      id: "product",
      ...
      products: [
        { id: "loop", name: "Loop", stage: "Shipped", tags: ["Mobile", "Banking"],
          ...
          features: [["Moment-first IA", "Organized by intent, not by org chart."], ["Calm by default", "The 90% case is one tap; the rest is one more."], ["Shipped at scale", "Live to hundreds of thousands of users."]],
          role: "Lead Product Designer", year: "2023", stage2: "Live",
          stack: ["UX", "Figma", "Mobile"], url: "https://example.com/loop" },
        { id: "canvas", name: "Canvas", stage: "Shipped", tags: ["Design system", "Web"],
          ...
          features: [["Token architecture", "Themeable foundations, not hard-coded values."], ["Contribution model", "Squads extend the system without forking it."], ["Adoption playbook", "How a system actually gets used, not shelved."]],
          role: "Design Systems Lead", year: "2022", stage2: "Live",
          stack: ["Tokens", "React", "Docs"], url: "https://example.com/canvas" },
        { id: "field", name: "Field", stage: "Beta", tags: ["Workflow", "Internal"],
          ...
          features: [["Queue-based UX", "Always a clear next thing to do."], ["Visible SLAs", "Everyone sees what's at risk, in real time."], ["Built with users", "Co-designed with the ops team, shipped weekly."]],
          role: "Lead Product Designer", year: "2025", stage2: "Private beta",
          stack: ["UX", "Ops", "Design"], url: "https://example.com/field" },
      ],
    },
  ],
};
